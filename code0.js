...
gdjs.LevelCode.GDplayernameObjects1= [];
gdjs.LevelCode.GDplayernameObjects2= [];
gdjs.LevelCode.GDplayernameObjects3= [];
gdjs.LevelCode.GDplayernameObjects4= [];
gdjs.LevelCode.GDLeaderboardObjects1= [];
gdjs.LevelCode.GDLeaderboardObjects2= [];
gdjs.LevelCode.GDLeaderboardObjects3= [];
gdjs.LevelCode.GDLeaderboardObjects4= [];
gdjs.LevelCode.GDtxtEntryObjects1= [];
gdjs.LevelCode.GDtxtEntryObjects2= [];
gdjs.LevelCode.GDtxtEntryObjects3= [];
gdjs.LevelCode.GDtxtEntryObjects4= [];
...
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18542100);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18543452);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18545732);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18546892);
}
}
if (isConditionTrue_0) {
...
for (var i = 0, k = 0, l = gdjs.LevelCode.GDCheckpointObjects2.length;i<l;++i) {
    if ( !(gdjs.LevelCode.GDCheckpointObjects2[i].getBehavior("Animation").getAnimationName() == "Activate") ) {
        isConditionTrue_0 = true;
...
for (var i = 0, k = 0, l = gdjs.LevelCode.GDPlayerObjects1.length;i<l;++i) {
    if ( gdjs.LevelCode.GDPlayerObjects1[i].getY() > gdjs.evtTools.camera.getCameraBorderBottom(runtimeScene, "", 0) ) {
        isConditionTrue_0 = true;
...
if (isConditionTrue_0) {
/* Reuse gdjs.LevelCode.GDPlayerObjects2 */
{gdjs.evtsExt__Player__TriggerDeath.func(runtimeScene, gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDPlayerObjects2Objects, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}}
...
gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDMonsterObjects1Objects = Hashtable.newFrom({"Monster": gdjs.LevelCode.GDMonsterObjects1});
gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDPlayerObjects2Objects = Hashtable.newFrom({"Player": gdjs.LevelCode.GDPlayerObjects2});
gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDMonsterParticlesObjects2Objects = Hashtable.newFrom({"MonsterParticles": gdjs.LevelCode.GDMonsterParticlesObjects2});
gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDPlayerObjects2Objects = Hashtable.newFrom({"Player": gdjs.LevelCode.GDPlayerObjects2});
gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDPlayerObjects1Objects = Hashtable.newFrom({"Player": gdjs.LevelCode.GDPlayerObjects1});
...
gdjs.LevelCode.GDPlayerObjects2.length = k;
if (isConditionTrue_0) {
gdjs.copyArray(gdjs.LevelCode.GDMonsterObjects1, gdjs.LevelCode.GDMonsterObjects2);

/* Reuse gdjs.LevelCode.GDPlayerObjects2 */
gdjs.LevelCode.GDMonsterParticlesObjects2.length = 0;

{for(var i = 0, len = gdjs.LevelCode.GDMonsterObjects2.length ;i < len;++i) {
    gdjs.LevelCode.GDMonsterObjects2[i].deleteFromScene(runtimeScene);
}
}{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDMonsterParticlesObjects2Objects, (( gdjs.LevelCode.GDMonsterObjects2.length === 0 ) ? 0 :gdjs.LevelCode.GDMonsterObjects2[0].getCenterXInScene()), (( gdjs.LevelCode.GDMonsterObjects2.length === 0 ) ? 0 :gdjs.LevelCode.GDMonsterObjects2[0].getCenterYInScene()), "");
}{gdjs.evtsExt__Player__Bounce.func(runtimeScene, gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDPlayerObjects2Objects, "PlatformerObject", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}{runtimeScene.getScene().getVariables().getFromIndex(0).add(50);
}}
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.LevelCode.GDPlayerObjects1.length;i<l;++i) {
    if ( !(gdjs.LevelCode.GDPlayerObjects1[i].getBehavior("PlatformerObject").isFalling()) ) {
        isConditionTrue_0 = true;
        gdjs.LevelCode.GDPlayerObjects1[k] = gdjs.LevelCode.GDPlayerObjects1[i];
        ++k;
    }
...
for (var i = 0, k = 0, l = gdjs.LevelCode.GDMonsterObjects2.length;i<l;++i) {
    if ( gdjs.LevelCode.GDMonsterObjects2[i].getBehavior("MonsterEnemy").IsOnFire((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
...
/* Reuse gdjs.LevelCode.GDMonsterObjects1 */

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.LevelCode.GDMonsterObjects1.length;i<l;++i) {
    if ( !(gdjs.LevelCode.GDMonsterObjects1[i].getBehavior("MonsterEnemy").IsOnFire((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined))) ) {
        isConditionTrue_0 = true;
        gdjs.LevelCode.GDMonsterObjects1[k] = gdjs.LevelCode.GDMonsterObjects1[i];
        ++k;
    }
}
gdjs.LevelCode.GDMonsterObjects1.length = k;
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("Monster"), gdjs.LevelCode.GDMonsterObjects1);
gdjs.copyArray(runtimeScene.getObjects("Player"), gdjs.LevelCode.GDPlayerObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDPlayerObjects1Objects, gdjs.LevelCode.mapOfGDgdjs_9546LevelCode_9546GDMonsterObjects1Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
{
gdjs.copyArray(runtimeScene.getObjects("EndScreenSubHeader"), gdjs.LevelCode.GDEndScreenSubHeaderObjects3);
{for(var i = 0, len = gdjs.LevelCode.GDEndScreenSubHeaderObjects3.length ;i < len;++i) {
    gdjs.LevelCode.GDEndScreenSubHeaderObjects3[i].getBehavior("Text").setText("You got " + gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().getFromIndex(0)) + " points!");
}
}}
...
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("EndScreenBestText"), gdjs.LevelCode.GDEndScreenBestTextObjects3);
{for(var i = 0, len = gdjs.LevelCode.GDEndScreenBestTextObjects3.length ;i < len;++i) {
    gdjs.LevelCode.GDEndScreenBestTextObjects3[i].hide();
}
}}
...
{for(var i = 0, len = gdjs.LevelCode.GDEndScreenChallengeTextObjects2.length ;i < len;++i) {
    gdjs.LevelCode.GDEndScreenChallengeTextObjects2[i].hide();
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18571308);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.LevelCode.GDRetryButtonObjects2.length;i<l;++i) {
    if ( gdjs.LevelCode.GDRetryButtonObjects2[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.LevelCode.GDRetryButtonObjects2[k] = gdjs.LevelCode.GDRetryButtonObjects2[i];
        ++k;
    }
}
gdjs.LevelCode.GDRetryButtonObjects2.length = k;
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("Leaderboard"), gdjs.LevelCode.GDLeaderboardObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.LevelCode.GDLeaderboardObjects1.length;i<l;++i) {
    if ( gdjs.LevelCode.GDLeaderboardObjects1[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.LevelCode.GDLeaderboardObjects1[k] = gdjs.LevelCode.GDLeaderboardObjects1[i];
        ++k;
    }
}
gdjs.LevelCode.GDLeaderboardObjects1.length = k;
if (isConditionTrue_0) {
...
{gdjs.evtTools.camera.hideLayer(runtimeScene, "EndScreen");
    ...
    gdjs.LevelCode.GDEndScreenBackgroundObjects2[i].getBehavior("Opacity").setOpacity(130);
}
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(18571052);
}
}
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("Moon"), gdjs.LevelCode.GDMoonObjects3);
{for(var i = 0, len = gdjs.LevelCode.GDMoonObjects3.length ;i < len;++i) {
    gdjs.LevelCode.GDMoonObjects3[i].setPosition(0.9 * gdjs.evtTools.camera.getCameraWidth(runtimeScene, "", 0) - (( gdjs.LevelCode.GDBackgroundPlantsObjects3.length === 0 ) ? 0 :gdjs.LevelCode.GDBackgroundPlantsObjects3[0].getXOffset()),100 - (( gdjs.LevelCode.GDBackgroundPlantsObjects3.length === 0 ) ? 0 :gdjs.LevelCode.GDBackgroundPlantsObjects3[0].getYOffset()));
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("txtEntry"), gdjs.LevelCode.GDtxtEntryObjects2);
...
}{runtimeScene.getScene().getVariables().get("User").getChild("name").setString((( gdjs.LevelCode.GDtxtEntryObjects2.length === 0 ) ? "" :gdjs.LevelCode.GDtxtEntryObjects2[0].getText()));
...
gdjs.LevelCode.eventsList18(runtimeScene);
}
...
gdjs.LevelCode.GDplayernameObjects1.length = 0;
gdjs.LevelCode.GDplayernameObjects2.length = 0;
gdjs.LevelCode.GDplayernameObjects3.length = 0;
gdjs.LevelCode.GDplayernameObjects4.length = 0;
gdjs.LevelCode.GDLeaderboardObjects1.length = 0;
gdjs.LevelCode.GDLeaderboardObjects2.length = 0;
gdjs.LevelCode.GDLeaderboardObjects3.length = 0;
gdjs.LevelCode.GDLeaderboardObjects4.length = 0;
gdjs.LevelCode.GDtxtEntryObjects1.length = 0;
gdjs.LevelCode.GDtxtEntryObjects2.length = 0;
gdjs.LevelCode.GDtxtEntryObjects3.length = 0;
gdjs.LevelCode.GDtxtEntryObjects4.length = 0;
